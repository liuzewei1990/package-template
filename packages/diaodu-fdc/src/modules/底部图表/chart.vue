...
<script>
  ...
  export default {
    ...
    data() {
      ...
      this.colors = {
        0: [
          ["rgba(67, 236, 255, 0.5)", "rgba(25, 29, 34, 0)", "rgb(67, 236, 255)"],
          ["rgb(66, 106, 255)", "rgb(25, 29, 34)", "rgb(74, 163, 248)"]
        ],
    ...
    mounted() {
      if (this.type == "0") {
        this.option.series = [
          createBarSerie({
            name: "辐照度",
            data: [30, 25, 55, 40, 20, 5, 28],
            color: ["rgba(67, 236, 255, 0.5)", "rgba(25, 29, 34, 0)", "rgb(67, 236, 255)"]
          }),
          createBarSerie({
            name: "功率",
            data: [10, 15, 25, 30, 40, 15, 20],
            color: ["rgb(66, 106, 255)", "rgb(25, 29, 34)", "rgb(74, 163, 248)"]
          })
        ];
      } else if (this.type == "1") {
        this.option.title = [];
